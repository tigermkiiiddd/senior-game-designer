...
| **规模边界** | 本游戏对标 ___ 的体量 | 防止设计膨胀 |

> **目标规模**：体量对标 [具体游戏名]。游戏类型：[品类]。预期游玩时长：[X小时通关 / X小时全收集]。后续所有系统的深度和复杂度不超过该对标水平。没有规模锚点的设计一定会膨胀。
...
> **玩家手里有什么，决定了成长线怎么设计。** 先列出玩家能持有的所有资源类型，才能梳理清楚：每条成长线消耗什么、产出什么、有没有断头路。

### 资源分类

| 资源类型 | 资源名 | 产出源头 | 消耗出口 | 成长线归属 |
|---------|--------|---------|---------|-----------|
| **硬通货** | [金币/钻石/...] | [核心循环结算/日常/...] | [商城/升级/抽卡/...] | [哪条成长线用它] |
| **软通货** | [经验/声望/...] | | | |
| **养成资源** | [强化石/技能点/...] | | | |
| **内容资源** | [角色/装备/关卡/...] | | | |
| **社交资源** | [公会贡献/好友度/...] | | | |
...
每条成长线 = 一种资源投入→能力/内容产出的路径。

| 成长线 | 投入资源 | 产出 | 深度（多少层） | 广度（多少变体） | 消耗速度 |
|--------|---------|------|-------------|---------------|---------|
| [角色养成] | [经验+金币+强化石] | [属性提升+技能解锁] | [X层] | [X个角色] | [X天满一个] |
| [装备系统] | | | | | |
| [...] | | | | | |

**自问**：
- 每条成长线的投入和产出能形成闭环吗？（投入的资源有稳定的获取途径吗？）
- 有没有"断头资源"——某种资源只有产出没有消耗，或只有消耗没有产出？
- 不同成长线之间有没有资源竞争？（共享同一种投入资源 → 玩家需要做取舍 → 这是博弈驱动的来源）
...
| **关键约束** | [平台/节奏/技术限制] |
| **玩家资源** | [硬通货]、[软通货]、[养成资源]、[内容资源]... — 核心成长线：[X条] |
